...
Differences in both the peaks and the daily duration of positive DNI values can be observed between the cubist model forecast and the actual data measurements over the course of the year. Forecast peak (monthly-averaged) Daily DNI forecasts for December, for example, are between 625 and 725 w/m2 whereas the actual measurements are in the range of 500 to 650 w/m2.

Nonetheless, overall the monthly-averaged daily DNI variation over the course of the year is however still a close correspondence with what we would expect given the mean absolute daily percentage error (MADPE) values obtained. Therefore, beyond the singular average daily percentage error measure for the DNI values, the time series forecast provide a reasonably accurate representation of the actual data.
...
Consistent with the derived RMSE and MADPE, which covered the entire forecast duration, the comparison of the DNI data forecasts for year 2 of the forecast period with that of the actual measurements again show good correspondence. There is also not an appreciably falloff in the forecast at two years into the future.
<br/>
<br/>
