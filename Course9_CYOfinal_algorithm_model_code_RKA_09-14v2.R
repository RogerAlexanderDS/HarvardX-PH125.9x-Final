...
############ External file download - if files have been manually downloaded
...
############ Automatic direct file download from GitHub Repository

remote_source_file <- datafile_label
if(!file.exists(remote_source_file)) download.file("https://github.com/RogerAlexanderDS/HarvardX-PH125.9x-Final/blob/main/solar_data_LOCID_1244690_2000-2020.csv", 
                remote_source_file)

remote_source_metafile <- metafile_label
if(!file.exists(remote_source_metafile)) download.file("https://github.com/RogerAlexanderDS/HarvardX-PH125.9x-Final/blob/main/solar_data_LOCID_1244690_2000-2020_meta.csv", 
                remote_source_metafile)


# Once files have been downloaded - Read in source file data for analysis (plus metadata) 
source_data <- read.csv(remote_source_file)
source_metadata <- read.csv(remote_source_metafile)
